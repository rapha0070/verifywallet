...
export default function Home() {
  useEffect(() => {
        ...
        try {
          ...
          if (connectWalletBtn) {
            connectWalletBtn.innerHTML =
              '<i class="ri-wallet-3-line"></i> Wallet Connected';
            connectWalletBtn.classList.remove("bg-gray-800", "hover:bg-gray-700");
    ...
    function handleVerification() {
      ...
      <h3 class="text-xl font-semibold mb-4">Connect Wallet Required</h3>
      <p class="text-gray-600 mb-6">Please connect your wallet first to verify your tokens.</p>
      <button class="w-full bg-primary text-white px-4 py-2 rounded-lg" onclick="this.parentElement.parentElement.remove()">
      OK
      </button>
      </div>
      `;
        ...
        window.location.href = "#verification-form";
      }
    }
    ...
    // Partner logos hover (if you add .partner-logo class)
    const logos = document.querySelectorAll(".partner-logo");
    logos.forEach((logo) => {
      (logo as HTMLElement).style.transition = "all 0.3s ease";
      ...
      logo.addEventListener("mouseout", () => {
        ...
        (logo as HTMLElement).style.opacity = "0.8";
      });
    });
  }, []);
  ...
  return (
    <>
      <Head>
        <title>KYC/AML and Crypto Compliance — All in One Place</title>
        <meta charSet="UTF-8" />
        ...
        <style>{`
          ...
          .hero-section {
            background-image: url('https://readdy.ai/api/search-image?query=modern%2520minimalist%2520crypto%2520wallet%2520interface%2520with%2520soft%2520gradient%2520background%2520in%2520light%2520blue%2520and%2520white%252C%2520subtle%2520geometric%2520patterns%252C%2520clean%2520design%2520elements%252C%2520professional%2520fintech%2520visualization%252C%2520airy%2520and%2520elegant%2520composition%252C%2520light%2520color%2520scheme&width=1600&height=800&seq=hero3&orientation=landscape');
          ...
          dangerouslySetInnerHTML={{
            __html: `
              tailwind.config = {
                theme: {
                  extend: {
                    colors: { primary: "#0066ff", secondary: "#4a5568" },
                    borderRadius: {
                      none: "0px",
                      sm: "4px",
                      DEFAULT: "8px",
      ...
      <div className="bg-gray-50 text-gray-800">
        ...
        <header className="bg-white shadow-sm">
          <div className="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div className="flex items-center">
              <button className="bg-primary text-white px-6 py-2 !rounded-button font-medium hover:bg-blue-600 whitespace-nowrap">
                Verify Tokens
              </button>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-12">
              <div className="md:w-1/2">
                ...
                <p className="text-lg text-gray-600 mb-8 max-w-2xl">
                  A complete solution for KYC and AML compliance, designed to meet
                  the highest standards, including FATF and FinCEN requirements. Not
                  just a platform, but a customer-focused approach to crypto
                  compliance.
                </p>
                <button className="bg-primary text-white px-8 py-4 !rounded-button font-medium text-lg hover:bg-blue-600 whitespace-nowrap">
                  Check your wallet
                </button>
              </div>
              <div className="md:w-1/2">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Our verification process is simple, secure, and reliable. Get your
                tokens verified in three easy steps.
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-10">
              <div className="bg-gray-50 p-8 rounded-lg text-center">
                ...
                <p className="text-gray-600">
                  Provide the token contract address and any additional information
              ...
              <div className="bg-gray-50 p-8 rounded-lg text-center">
                ...
                <p className="text-gray-600">
                  Complete a secure payment of the verification fee (starting at
                  0.29 USDT).
                </p>
              </div>
              <div className="bg-gray-50 p-8 rounded-lg text-center">
                ...
                <p className="text-gray-600">
                  Get your official validity certificate confirming the status of
                  your tokens.
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-gray-50 p-8 rounded-lg">
                ...
                <p className="text-gray-600">
                  Some tokens may be frozen by their issuers or smart contracts,
                  rendering them untradeable. Our verification helps identify frozen
              ...
              <div className="bg-gray-50 p-8 rounded-lg">
                ...
                <p className="text-gray-600">
                  Scammers often create counterfeit tokens that appear legitimate.
                  We verify token authenticity to protect you from worthless
                  imitations.
                </p>
              </div>
              <div className="bg-gray-50 p-8 rounded-lg">
                ...
                <p className="text-gray-600">
                  Smart contracts can be blocked or blacklisted, preventing token
                  transfers. Our system detects these restrictions before you trade.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 items-center">
                <div className="flex items-center justify-center">
                  <img
                    ...
                    alt="Purefi"
                    className="h-8 object-contain partner-logo"
                  />
                </div>
                <div className="flex items-center justify-center">
                  <img
                    src="https://readdy.ai/api/search-image?query=credits%2520crypto%2520company%2520logo%20modern%2520minimal%2520design%2520dark%2520theme&width=120&height=40&seq=logo2&orientation=landscape"
                    alt="Credits"
                    className="h-8 object-contain partner-logo"
                  />
                </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-600 mb-12">
                Connect your wallet and verify your tokens in just a few simple
                steps
              </p>
              <div className="flex flex-col items-center gap-4">
                <button
                  className="bg-primary text-white px-8 py-4 !rounded-button font-medium text-lg hover:bg-blue-600 whitespace-nowrap w-64"
                  id="verify-btn"
                >
                  Verify Token Now
                </button>
                <button
                  className="bg-gray-800 text-white px-8 py-4 !rounded-button font-medium text-lg hover:bg-gray-700 whitespace-nowrap w-64 flex items-center justify-center gap-2"
              ...
              <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-gray-50 p-8 rounded-lg">
                  ...
                  <p className="text-gray-600">
                    Comprehensive smart contract security analysis and risk
                    assessment
                  </p>
                </div>
                <div className="bg-gray-50 p-8 rounded-lg">
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <button className="bg-white text-primary px-8 py-4 !rounded-button font-medium text-lg hover:bg-gray-100 whitespace-nowrap">
